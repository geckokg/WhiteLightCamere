...
add_files -fileset constrs_1 -norecurse [file join $root_dir "constraints" "python1300_cam_j31_template.xdc"]
set_property top cam_python1300_top [current_fileset]
update_compile_order -fileset sources_1

puts "Created Vivado project at $proj_dir"
puts "Next: create a block design with Zynq MPSoC, a 100 MHz PL clock, a 72 MHz camera reference clock, and connect cam_python1300_top AXI master to an HP/HPC DDR port."
